...
CREATE TABLE IF NOT EXISTS EventDocument (
  ...
  file_category ENUM('flyer', 'contract', 'receipt', 'budget', 'promo', 'other') NOT NULL DEFAULT 'other',
  visibility ENUM('private', 'committee', 'council') NOT NULL DEFAULT 'private',
  uploaded_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_event_document_event_uploaded (event_id, uploaded_at),
  INDEX idx_event_document_uploaded_by (uploaded_by),
